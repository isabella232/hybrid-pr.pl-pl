...
- Utwórz [aplikację internetową](/aspnet/core/tutorials/publish-to-azure-webapp-using-vs) na platformie Azure. Zanotuj adres URL aplikacji sieci Web, ponieważ będzie on potrzebny w rozwiązaniu.
...
- [Utwórz plany i oferty](/azure-stack/operator/service-plan-offer-subscription-overview) w środowisku centrum Azure Stack.
...
| Brama Virtual Network Azure Stack Hub | AzureStack-Gateway |  |  |
